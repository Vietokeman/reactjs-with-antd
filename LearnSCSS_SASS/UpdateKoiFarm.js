  ...
  useEffect(() => {
    if (record) {
      const formattedRecord = {
        ...record,
        openHour:
          record.openHour && moment(record.openHour, "HH:mm").isValid()
            ? moment(record.openHour, "HH:mm")
            : null,
        closeHour:
          record.closeHour && moment(record.closeHour, "HH:mm").isValid()
            ? moment(record.closeHour, "HH:mm")
            : null,
      };
